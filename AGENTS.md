...
| `database-guidelines` | `.claude/skills/database-guidelines/SKILL.md` | 数据库设计、SQL 安全、索引原则 |
| `error-handling` | `.claude/skills/error-handling/SKILL.md` | 异常处理、结构化错误响应、日志规范 |
| `security` | `.claude/skills/security/SKILL.md` | 安全编码（OWASP Top 10） |
| `redis-guidelines` | `.claude/skills/redis-guidelines/SKILL.md` | Redis 最佳实践、缓存模式 |
