// Core-level dependency identifiers and reference URLs for supported agents.
// These are shared scaffold constants, not runtime implementation details.
