...
- implementation flow: 如果项目已应用 foundation，先读取 `.praxis/foundation/README.md` 与 `.praxis/foundation/profile/`，把 foundation 视作运行时基线；开始实现前优先检查其中的 `branch-workflow.md`、`verification.md`、`operating-agreements.md`；OpenSpec 仅在治理 / proposal 场景中作为入口。
